...
/* Main program */
  int main(){
    ...
    // Tutorial Aspect. Displaying the current status of the program.
    cout<<"============================Welcome!========================"<<endl;
    cout<<"...Introduction..."<<endl;
    cout<<"Welcome! This is a demo of the dynamic approach for the knapsack problem";
    cout<<endl<<endl;

    // Tutorial Aspect. Displaying the current status of the program.
    cout<<"...Variable Initialization..."<<endl;
    cout<<"Here, we initialize the input variables for the test case";
    ...
    // Tutorial Aspect. Displaying the current status of the program
    cout<<"...Variable Status..."<<endl;
    cout<<"Here, we display the varriable values that have been initialized...";
    cout<<endl;
